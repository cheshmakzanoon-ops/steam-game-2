...
- [Product Charter](docs/phase-001/PRODUCT_CHARTER.md)
...
- **Price hypothesis:** USD $14.99
- **Run target:** 35–50 minutes
- **Engine pin:** Godot 4.7.2-stable
- **Asset-authoring pin:** Blender 4.5.14 LTS
- **Production target:** 12–15 months full-time; 18-month hard safety ceiling

No production gameplay or final art is authorized until the required preproduction gates permit it.
